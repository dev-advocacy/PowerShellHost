...
void Thread::Begin()
{
    ...
    // Start the thread.
    d_threadHandle = CreateThread(nullptr, 0, (LPTHREAD_START_ROUTINE)StaticThreadProc, this, 0, (LPDWORD)&d_threadID);
    if (d_threadHandle == nullptr)
    {
